...
$id=$s11['id'];
$product= "select * from cart where uid= $id";
                    ...
                    <figure>
                      <div><img src="img/seller/images.jpg" alt=""></div>
                        ...
                        <p><?php echo $pro1['name'];?></p>
                         <p> <?php echo $p1['qty'];?>x Rs<?php echo $pro1['cost']?>= <?php $mul= ($p1['qty']* $pro1['cost']); echo 'Rs'; echo$mul;?></p>
                        
                        <p>
                          
                          <a href="prodinfo.php?pid=<?php echo $p1['pid'];?>" class="btn btn-color">Details</a>
                          <a href="remove.php?i=<?php echo $p1['id'];?>" class="btn btn-color" >Remove</a>
                      
                          <a href="buy.php?i=<?php echo $p1['id'];?>" class="btn btn-color margintop10" >Buy Now</a>
                        </p>
