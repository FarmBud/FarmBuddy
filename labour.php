...
{
    $i= $s11['id'];
    $insert= "insert into  docservreq(`farmerid`,`name`,`email`,`phone`, `add`, `des`, `rtype`, `res`) values ('$i','".mysql_real_escape_string($_REQUEST['name'])."','".mysql_real_escape_string($_REQUEST['email'])."', '".mysql_real_escape_string($_REQUEST['phone'])."','".mysql_real_escape_string($_REQUEST['addr'])."','".mysql_real_escape_string($_REQUEST['des'])."','Labour','requested')";
