...
$id=$s11['id'];
$product= "select * from rentorder where sid= '$id' and `res`= 'placed'";
              ...
              if(mysqli_num_rows($p)>0)
                ...
                <div class="span8">
                  <div class="item">
                        ...
                        <h6>Product: <?php echo $p1['name']; ?></h6>
                        <p>Quantity: <?php echo $p1['qty'];?></p>
                        <p>Req Days: <?php echo $p1['day'];?></p>
                        ...
                        <a href=" executedrentorder.php?i=<?php echo $p1['id'];?> " class="btn btn-color margintop10"> Executed</a>
                  </div>
                </div>
                <?php }?>
