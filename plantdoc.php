...
{
   $i= $s11['id'];
    $insert= "insert into  docservreq( `farmerid`,`name`,`email`,`phone`, `add`, `des`, `rtype`, `res`) values ('$i','".mysql_real_escape_string($_REQUEST['name'])."','".mysql_real_escape_string($_REQUEST['email'])."', '".mysql_real_escape_string($_REQUEST['phone'])."','".mysql_real_escape_string($_REQUEST['addr'])."','".mysql_real_escape_string($_REQUEST['des'])."','Plant Test','requested')";
          ...
          <div class="span8">
                ...
                <div class="span8">
                  <div class="post-image">
                    <div class="post-heading">
                      <h3>Soil Doctor <small>24/7 free service for farmers </small></h3> 
            ...
            <article>
              <div class="row">
                ...
                <div class="span8">
              <div style="background-color: darkgreen; border-bottom-color: black; border-bottom-style: solid; border-bottom-width: 8px; padding-top:18px;">
                 <h4 style="color: white; font-weight: lighter;"> Enter your contact details to get your plant tested</h4>
                   </div>
                    <?php
